...
public class OrderApiController implements OrderApi {
    ...
    public ResponseEntity<Order> orderPost(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Order body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Order>(objectMapper.readValue("{\n  \"quantity\" : 1,\n  \"productId\" : 1234,\n  \"id\" : 1,\n  \"orderDate\" : \"2019-01-11T00:37:30Z\",\n  \"customer\" : {\n    \"firstName\" : \"Kimani\",\n    \"lastName\" : \"Njoroge\",\n    \"phone\" : \"555-555-5555\",\n    \"customerNumber\" : \"d290f1ee\"\n  }\n}", Order.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
